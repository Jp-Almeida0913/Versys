...
google = oauth.register(
    name='google',
    client_id='1090164616049-sjvqsq337ia359nm3gtm1fbchqbbcc22.apps.googleusercontent.com',
    client_secret='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',
...
def send_email():
    if request.method == 'POST':
        ...
        body = request.form.get('body') #obs
        user_email = session['user']['email'] if 'user' in session else 'Desconhecido'
        body = f"Usuário: {user_email}\n\n{body}"
        recipient = 'otaviobhzero@gmail.com'  # Destinatário fixo
